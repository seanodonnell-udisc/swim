...
/**
 * An in-memory [Settings]. The persistence tests need somewhere to write that survives one test
 * and nothing more, and multiplatform-settings keeps its own in-memory implementation in a
 * separate artifact that :core does not depend on.
 */
